...
public class CheckOut extends Utility {
    ...
    public void basicFormFillUp(){
        doubleClickAndSendKeysOnElement(inputFirstName,"kajal");
        doubleClickAndSendKeysOnElement(inputLastName,"patel");
        doubleClickAndSendKeysOnElement(inputEMailAddress,"xyz123@gmail.com");
        ...
        doubleClickAndSendKeysOnElement(inputAddressLineOne,"40, watford");
        doubleClickAndSendKeysOnElement(inputAddressLineTwo,"by the wood");
        doubleClickAndSendKeysOnElement(inputZipPostalCode,"526235");
        doubleClickAndSendKeysOnElement(inputPhoneNumber,"07686359423");
        doubleClickAndSendKeysOnElement(inputFaxNumber,"0269863569");
    ...
    public void fillCreditCardDetails(){
        ...
        doubleClickAndSendKeysOnElement(cardHolderName,"kajal Patel");
        doubleClickAndSendKeysOnElement(cardHolderNumber,"5569898956895623");
        selectValueFromdropDown(cardHolderExpMonthDropDown,"8");
        selectValueFromdropDown(cardHolderExpYearDropDown,"2026");
